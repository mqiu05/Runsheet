...
def clear_inputs(n_clicks, general_section_style, notes_section_style):
    if n_clicks:
        general_clear = ['', None, '', '', '', ''] if general_section_style['display'] == 'block' else [None]*6
        notes_clear = ['', '', '', ''] if notes_section_style['display'] == 'block' else [None]*4

        return general_clear + notes_clear
    return [None] * 10
